    ...
    return (
        <section className="bg-services bg-cover flex justify-between w-screen">
            <div className="w-1/3 p-8">
                ...
                <p className="text-white py-4">Dépannage, assistance et fiabilisation d’équipements automatisés</p>
                <p className="text-white py-4">Nous intervenons dans les domaines industrielles manufacturier et agro-alimentaire ainsi que dans l’environnement et le tertiaire.</p>
            </div>
